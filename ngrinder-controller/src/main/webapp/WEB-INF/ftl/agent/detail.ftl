...
<html>
	...
	<body>
		...
		<script>
			...
			var cpuChart = drawChart('cpu_usage_chart', [cpuUsage.aElement], formatPercentage, interval);
			var memoryChart = drawChart('memory_usage_chart', [memoryUsage.aElement], formatMemory, interval);
